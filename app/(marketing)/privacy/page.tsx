    ...
    <div className="bg-background min-h-screen py-6 md:py-16">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-5 md:mb-12 text-center">
          <h1 className="text-2xl md:text-5xl font-black tracking-tighter mb-2 md:mb-4 uppercase">
        ...
        <div className="prose prose-zinc dark:prose-invert max-w-none space-y-4 md:space-y-8">
          ...
          <section className="bg-white dark:bg-zinc-950 p-5 md:p-8 rounded-xl md:rounded-[2rem] border border-border/50 shadow-xl shadow-zinc-200/50 dark:shadow-none font-medium">
            <h2 className="text-lg md:text-2xl font-bold mb-2 md:mb-4 flex items-center gap-3">
          ...
          <section className="bg-white dark:bg-zinc-950 p-5 md:p-8 rounded-xl md:rounded-[2rem] border border-border/50 shadow-xl shadow-zinc-100 dark:shadow-none">
            <h2 className="text-lg md:text-2xl font-bold mb-2 md:mb-4 flex items-center gap-3">
