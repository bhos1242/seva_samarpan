        ...
        <section className="relative overflow-hidden bg-background py-6 md:py-14">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-3xl mx-auto text-center space-y-2 md:space-y-3">
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-primary/10 text-primary text-[10px] md:text-sm font-semibold mb-1">
                    ...
                    <p className="text-sm md:text-lg text-muted-foreground max-w-2xl mx-auto leading-snug">
                        We run a free library for students and a home for elders in Pune.
                    </p>
                </div>
            </div>
        </section>
