        ...
        <section className="py-5 md:py-10 bg-background">
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-5 md:gap-8 items-center">
                    <div className="flex-1 space-y-3 md:space-y-4 text-muted-foreground text-xs md:text-base leading-relaxed font-bold">
                        <h2 className="text-xl md:text-4xl font-black text-foreground mb-2 md:mb-4">Our <span className="text-primary italic">Story</span></h2>
                        <p>
