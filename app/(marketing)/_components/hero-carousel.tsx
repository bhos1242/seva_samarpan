...
const programs = [
    {
        ...
        description: 'Free Library and study room for tribal and underprivileged students.',
    ...
    {
        id: 1,
        title: '1200 Initiative',
        description: 'Empowering communities through targeted initiatives and sustainable development programs.',
        image: '/programs/1200_initiative.png',
        link: '#',
        color: 'bg-blue-500',
    },
    {
        id: 2,
        title: 'Vidya Adhar',
        description: 'Supporting quality education and learning opportunities for underprivileged children.',
